...
namespace Homework1
{
    public partial class AlexHomework1ExtraCredit : Form
    {
        ...
        {
            AlexHomework1SuperDuperExtraCreditForm newAlexHomework1SuperDuperExtraCreditForm = new AlexHomework1SuperDuperExtraCreditForm();
            newAlexHomework1SuperDuperExtraCreditForm.ShowDialog();
        }
