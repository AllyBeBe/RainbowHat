...
namespace CalculatorControllerTests
{
    ...
    public class SuTests
    {
        ...
        public void CanAddDecimalNumbers()
        {
            ...
            Assert.That(_controller.GetOutput(), Is.EqualTo("3.0"));
         }

        [Test]
        public void CanSubstractDecimalNumbers()
        {
            _controller.AcceptCharacter('5');
            _controller.AcceptCharacter('.');
            _controller.AcceptCharacter('5');
            ...
            Assert.That(_controller.GetOutput(), Is.EqualTo("4.5"));
        }
        ...
        public void CanMultiplyDecimalNumbers()
        {
            ...
            Assert.That(_controller.GetOutput(), Is.EqualTo("0.04"));
        }
        ...
        public void CanDivideDecimalNumbers()
        {
            ...
            Assert.That(_controller.GetOutput(), Is.EqualTo("21"));
        }
